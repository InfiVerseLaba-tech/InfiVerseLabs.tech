  ...
  return (
    <div className="pt-24">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
                <AnimatedSection>
                    <GlowCard className="h-full">
                        <h3 className="font-heading text-2xl font-bold text-red-400">Problem</h3>
                        <p className="mt-2 text-slate-300">{service.problemSolution.problem}</p>
                    </GlowCard>
                </AnimatedSection>
                <AnimatedSection delay={200}>
                    <GlowCard className="h-full border-sky-400/50 shadow-sky-500/10">
                        <h3 className="font-heading text-2xl font-bold text-sky-300">Solution</h3>
                        <p className="mt-2 text-slate-300">{service.problemSolution.solution}</p>
                    </GlowCard>
                </AnimatedSection>
                <AnimatedSection delay={400}>
                    <GlowCard className="h-full">
                        <h3 className="font-heading text-2xl font-bold text-green-400">Result</h3>
                        <p className="mt-2 text-slate-300">{service.problemSolution.result}</p>
                    </GlowCard>
                </AnimatedSection>
            </div>
        </div>
      ...
      <section className="py-20 bg-slate-900/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection>
                <h2 className="font-heading text-4xl md:text-5xl font-bold text-center">Core Capabilities</h2>
            </AnimatedSection>
                    ...
                    <AnimatedSection key={index} delay={index * 100}>
                        <div className="flex items-start gap-6 mb-8">
                           ...
                           <div>
                                ...
                                <p className="text-slate-400 mt-1">{feature.description}</p>
                           </div>
                        </div>
                    </AnimatedSection>
                ))}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection>
                <h2 className="font-heading text-4xl md:text-5xl font-bold text-center">Frequently Asked <GradientText>Questions</GradientText></h2>
            </AnimatedSection>
